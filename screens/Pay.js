    ...
    render() {
        return (
            ...
            >
                ...
                <View style={{ alignItems: 'center', height: 400, justifyContent: 'space-between' , marginTop: 70 }}>
                    ...
                    <Button style={{width: 300, borderRadius: 5, alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5da42'}}><Text style={{fontSize: 18}}>PROCEED TO PAY</Text></Button>
                </View>
            </ScrollView>
        )
    }
