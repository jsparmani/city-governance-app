            ...
            <ScrollView style={styles.screen}>
                ...
                {/* <View>
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{alignItems: 'center', shadowColor: 'black', shadowOffset: {width: 10, height: 10}, elevation: 10}}>
                            <Image source={{
                                uri: 'https://media-cdn.tripadvisor.com/media/photo-s/08/b7/1f/31/qutab-minar.jpg'
                            }}
