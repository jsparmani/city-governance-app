...
import { Button, Textarea, Content, ListItem, Radio, Right, Left } from 'native-base';
        ...
        return (
            <View>
                <View style={{ margin: 10, marginTop: 20, justifyContent: 'space-evenly', alignContent: 'flex-start', flexDirection: 'column' }}>
                    ...
                    <TextInput
                        placeholder={'Name'}
                        onChangeText={text => { this.setState({ scheme_name: text }) }}
                        style={{
                            width: '90%',
                ...
                <Textarea
                    ...
                    onChangeText={text => { this.setState({ scheme_descp: text }) }}
                />
                <ListItem selected={false} >
                    ...
                    <Right>
                        <Radio
                            ...
                            onPress={() => this.setState({ selectedItem: 'upcoming' })}
                ...
                <ListItem selected={true}>
                    ...
                    <Right>
                        <Radio
                            ...
                            onPress={() => this.setState({ selectedItem: 'completed' })}
                        />
                    </Right>
                </ListItem>
                <ListItem selected={true}>
                    ...
                    <Right>
                        <Radio
                            ...
                            onPress={() => this.setState({ selectedItem: 'progress' })}
                        />
                    </Right>
                </ListItem>
