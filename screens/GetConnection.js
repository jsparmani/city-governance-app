    ...
    render() {
        return (
            ...
            >
                ...
                <View style={{ alignItems: 'center', justifyContent: 'space-between', marginTop: 70 }}>
                    ...
                    <Button
                        ...
                        style={{ padding: 10, borderRadius: 5, marginTop: 40, height: 60, alignItems: 'center', justifyContent: 'center' }}
                    >
